...
void DirectXCommon::InitilaizeCommand()
{
    HRESULT result;
...
void DirectXCommon::InitilaizeSwapchain()
{
    HRESULT result;
...
void DirectXCommon::InitilaizeRenderTargetView()
{
    // デスクリプタヒープの設定
...
void DirectXCommon::InitilaizeFence()
{
    HRESULT result;
